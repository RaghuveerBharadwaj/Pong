...
const topWall = Bodies.rectangle(custWidth / 2, 0, custWidth, 20, {
  isStatic: true,
  density: 10000,
  restitution: 1,
});
const leftWall = Bodies.rectangle(0, custHeight / 2, 20, custHeight, {
  isStatic: true,
  density: 10000,
});
const rightWall = Bodies.rectangle(custWidth, custHeight / 2, 20, custHeight, {
  isStatic: true,
  density: 10000,
});
const bottomWall = Bodies.rectangle(custWidth / 2, custHeight, custWidth, 20, {
  isStatic: true,
  density: 10000,
  restitution: 1,
});

const bat1 = Bodies.rectangle(custWidth - 50, custHeight / 2, 20, 200, {
  restitution: 1,
  isStatic: true,
  render: { fillStyle: "skyblue" },
});
const bat2 = Bodies.rectangle(50, custHeight / 2, 20, 200, {
  restitution: 1,
  isStatic: true,
